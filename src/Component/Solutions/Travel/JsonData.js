import Travel1 from '../../image/Solutions/Travel.png';
import Travel2 from '../../image/Solutions/Travel2.png';
import Travel3 from '../../image/Solutions/Travel3.png';
    ...
    items: [
      {
        id: 1,
        icon: "bi-geo-alt",
        title: "Personalized Itinerary Sharing",
        anime: "zoom-in-right",
        description: "Easily share tailored itineraries, travel guides, and updates directly with customers."
      },
      {
        id: 2,
        icon: "bi-calendar",
        ...
        anime: "zoom-in-up",
        description: "Send automated reminders for bookings, payments, and trip schedules, ensuring a hassle-free experience."
      },
      {
        id: 3,
        icon: "bi-chat",
        ...
        anime: "zoom-in-left",
        description: "Provide round-the-clock assistance via AI-powered chatbots on WhatsApp or RCS platforms."
      },
      {
        id: 4,
        icon: "bi-camera-video",
        title: "Interactive Travel Campaigns",
        anime: "zoom-in-right",
        description: "Promote travel packages with engaging media-rich RCS messages and quick action buttons."
      },
      {
        id: 5,
        icon: "bi-credit-card",
        ...
        anime: "zoom-in-down",
        description: "Ensure secure payment alerts and confirmations through encrypted messaging services."
      },
      {
        id: 6,
        icon: "bi-people",
        ...
        anime: "zoom-in-left",
        description: "Stay connected with customers post-travel through personalized offers and updates."
      }
    ]
  };
