...
export const HealthcareTimeline = {
  title: "Transform Healthcare Communication with Modern Solutions",
  items: [
    {
      id: 1,
      stepTitle: "Streamlined Appointments",
      title: "Efficient Scheduling with WhatsApp",
      description:
        "Enable instant appointment bookings and automated reminders via WhatsApp. Provide real-time updates and streamline patient schedules effortlessly.",
    ...
    },
    {
      ...
      title: "Safe and Hassle-Free Payment Processing",
      description:
        "Use OTP services for secure patient verification and payment confirmations. Build trust with encrypted communication for financial transactions.",
      icon: "bi-lock-fill",
      anime: "fade-left",
    },
    {
      id: 3,
      stepTitle: "24/7 Patient Assistance",
      title: "Round-the-Clock Support",
      description:
        "Offer 24/7 support with AI-powered chatbots on WhatsApp and RCS. Address patient inquiries, provide health tips, and deliver real-time updates efficiently.",
      icon: "bi-headset",
      anime: "fade-right",
    },
    {
      id: 4,
      stepTitle: "Engaged Patient Relationships",
      title: "Build Long-Term Patient Trust",
      description:
        "Share personalized health tips, follow-ups, and care plans through WhatsApp and RCS. Foster loyalty and enhance patient satisfaction.",
      icon: "bi-heart",
      anime: "fade-left",
    },
  ],
