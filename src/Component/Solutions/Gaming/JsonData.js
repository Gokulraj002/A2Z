    ...
    items: [
      {
        id: 1,
        icon: "bi-controller",
        title: "Engage Players Instantly",
        anime: "zoom-in-right",
        description:
          "Send real-time game updates, exclusive offers, and event invitations to keep players immersed.",
      },
      {
        id: 2,
        icon: "bi-trophy",
        title: "Simplify Tournament Alerts",
        anime: "zoom-in-down",
        description:
          "Share schedules, results, and reminders effortlessly to enhance tournament coordination.",
      },
      {
        id: 3,
        ...
        anime: "zoom-in-left",
        description:
          "Provide quick assistance for account recovery and queries to ensure a seamless experience.",
      },
      {
        id: 4,
        icon: "bi-chat-dots",
        ...
        anime: "zoom-in-right",
        description:
          "Deliver instant alerts for new features, events, or rewards directly to your players.",
      },
      {
        id: 5,
        icon: "bi-wallet2",
        title: "Secure Payment Reminders",
        anime: "zoom-in-up",
        description:
          "Notify players about pending purchases, subscription renewals, and in-game transactions securely.",
      },
      {
        id: 6,
        icon: "bi-graph-up-arrow",
        title: "Optimize Campaign Success",
        anime: "zoom-in-left",
        description:
          "Track SMS performance and refine engagement strategies with detailed analytics.",
      },
    ],
  };
  

  export const GamingFAQ = {
    title: "Gaming Services - FAQs",
    faqs: [
      {
        id: 1,
